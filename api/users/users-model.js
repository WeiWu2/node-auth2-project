...
function find() {
  return db('users').select('user_id', 'username', 'roles.role_name').leftJoin('roles', 'users.role_id', 'roles.role_id')
}

function findBy(filter) {
  return db('users').select('user_id', 'username', 'password', 'roles.role_name').leftJoin('roles', 'users.role_id', 'roles.role_id').where(filter)
  /**
